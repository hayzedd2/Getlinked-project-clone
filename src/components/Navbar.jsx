...
import closeBtn from '../images/Vector (6).png'
import closeBtnBg from '../images/Group 1.png'
const Navbar = () => {
    ...
    <>
      <div className="nav-container">
        <nav>
          ...
          <div className="show-burger" ref={burgerRef} onClick={handleClick} >
            <svg
              width="19"
              height="14"
              viewBox="0 0 19 14"
          ...
          <div className="mobile-nav-show" ref={mobileNavRef}>
           <div className="close-btn-div">
           <div className="close-btn" ref={closeBtnRef} onClick={closeNav}>
